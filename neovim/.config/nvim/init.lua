...
-- trim whitespace on line ending
...
require('lazy').setup {
  ...
  'vifm/vifm.vim', -- Vifm file navigator

  -- Note-taking
  'vimwiki/vimwiki', -- Personal iki for Vim

  {
    'zbirenbaum/copilot.lua', -- GitHub Copilot, working
    config = function()
    ...
    config = function()
      ...
      require('telescope').setup {
        ...
        defaults = {
          ...
          layout_config = { height = 0.95, width = 0.90 },

          mappings = {
            i = {
              ['<c-enter>'] = 'to_fuzzy_refine',
              ['<C-h>'] = 'which_key',
              ['<c-space>'] = require('telescope.actions').delete_buffer,
            },
            n = {
